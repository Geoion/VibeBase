...
import "./i18n/config";
import ArenaWindow from "./components/arena/ArenaWindow";
...
function ArenaApp() {
  ...
  const handleClose = async () => {
    try {
      ...
      console.log("Closing arena window from entry point...");
      await window.close();
      console.log("Arena window closed successfully from entry point");
    } catch (error) {
      console.error("Failed to close arena window from entry point:", error);
    }
  };
